...
public class StatisticsController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var responseMessage3 = await client3.GetAsync("https://localhost:44350/api/Statistics/ApartmentCount");
        ...
        var responseMessage5 = await client5.GetAsync("https://localhost:44350/api/Statistics/AverageProductPriceBySale");
        ...
        var responseMessage6 = await client6.GetAsync("https://localhost:44350/api/Statistics/AverageRoomCount");
